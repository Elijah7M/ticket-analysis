...
day_of_week_values = ['All Days of the Week', 'Monday','Tuesday','Wednesday','Thursday','Friday','Saturday','Sunday']
event_time_values = df['Event Time'].sort_values().unique()

# Create the day of week dropdown options
day_of_week_dropdown_options = day_of_week_options
...
if __name__ == "__main__":
>>>>>>> 8a4479ed919873a3f38998e18e0bbf1b3b6719d5
